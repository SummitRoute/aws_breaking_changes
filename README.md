...
| May 9, 2024 | May 9, 2024 | Cognito |  Price increase where machine-to-machine Cognito went from being free to being charged. ([link](https://aws.amazon.com/about-aws/whats-new/2024/05/amazon-cognito-tiered-pricing-m2m-usage/)) | |
...
| November 29, 2024 | Unknown | Finspace | New FinSpace Dataset Browser environments can no longer be created  ([link](https://docs.aws.amazon.com/finspace/latest/management-api/API_UpdateEnvironment.html)) | |
